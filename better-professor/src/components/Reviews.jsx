        ...
        <ReviewsDiv>
            <h2>See what customers are saying about Better Professor!</h2> 
                <div className='review'>
                    <h3>Deborah S.<img height='50px' width='300px' src={FiveStars} /></h3>
                    <p>January 29, 2020</p>
                ...
                <div className='review'>
                    <h3>Sally May J.<img height='50px' width='300px' src={FiveStars} /></h3>
                    <p>December 15, 2019</p>
                    <p>Wow! Just Wow!</p>
                </div>
                <div className='review'>
                    <h3>Dr. Phillip W.<img height='50px' width='300px' src={FiveStars} /></h3>
                    <p>October 10, 2019</p>
                    <p>This app helps keep me at the top of my game!</p>
                </div>
                <div className='review'>
                    <h3>Millicent C.<img height='50px' width='300px' src={FiveStars} /></h3>
                    <p>October 27, 2019</p>
                ...
                <div className='review'>
                    <h3>Joe Bob D.<img height='50px' width='300px' src={FiveStars} /></h3>
                    <p>September 9, 2019</p>
                    <p>A great way to stay on top of deadlines.</p>    
                </div>
                <div className='review'>
                    <h3>Roberto V.<img height='50px' width='300px' src={FiveStars} /></h3>
                    <p>January 29, 2019</p>
